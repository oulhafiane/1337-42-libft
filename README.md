...
> I added some extras, if the variable named content_size given in argument is 0, the variable named content of the new link will get a copy of the address of the variable named content given in argument,
But otherwise, the variable named content of the new link will get a new allocated memory address returned by ft_strdup (content).
#### ft_lstdelone
...
>Iterates the list lst and calls the function f by sending it two arguments: the first is the current link in the loop and the second is the obj arguments given to ft_lstsearch, and if the return value of the function is 1,  
the ft_lstsearch function returns the current link.  
If the f function never returned 1, ft_lstsearch returns NULL.

#### void&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ft_lstrev(t_list \*\*begin_list);
>Reverse the order of links on the given list.

#### void&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ft_lstadd_end(t_list \*\*alst, t_list \*new);
>The opposite of ft_lstadd which adds the new link at the top of the list, but ft_lstadd_end adds the new link at the end of the list.

#### void&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ft_lstcontent_iter(t_list \*lst, void (\*f)(void *elem));
>Iterates the list lst and applies the function f to each content of the link.

#### void&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ft_lstsort(t_list \*\*begin_list, int (\*cmp)());
>Sorts the list’s by comparing two links thanks to a function that can compare the data held in those two links.

#### int&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ft_lstlen(t_list \*lst);
>Returns the number of links in the linked list given as an argument.

#### void&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ft_str_replace(char \*\*str, char \*old, char *new);
>Allocates enough memory for a copy of the variable named str, but each word of the string str corresponding to the string old replaced by the string new.  
And it frees the old str address.  
And return the address of the new allocated memory.

#### char&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*ft_remove_char(char \*\*str, char c);
>Allocates enough memory for a copy of the variable named str, but each character in the string str corresponding to the character c will be deleted.  
And it frees the old str address.  
And return the address of the new allocated memory.

#### char&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*ft_strjoin_pre(char const \*s1, char \*delimiter, char const \*s2);
>Same as ft_strjoin but this time it concatenates 3 strings together.

#### int&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ft_str_isalnum(char \*str);
>The function performs a test for each character of the str string using the ft_isalnum function if a test fails, the function returns 0, otherwise, it returns 1.

#### int&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ft_str_isalpha(char \*str);
>The function performs a test for each character of the str string using the ft_isalpha function if a test fails, the function returns 0, otherwise, it returns 1.
